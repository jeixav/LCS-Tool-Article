...
Results are from the function \lstinline!eig_cgStrain! applied to the double gyre presented in \cref{sec:double gyre}.
...
As discussed in \cref{sec:Hyperbolic LCSs}, hyperbolic LCS positions at time $t_0$ are found as the strongest repelling curves of the vector field \cref{eq:shrink line} (repelling LCSs), and strongest attracting curves of the vector field \cref{eq:stretch line} (attracting LCSs).
