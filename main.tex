...
% FIXME "centrepiece" is vague and may confuse with centre fixed point in classical dynamical systems
...
% FIXME "Centres" may be associated with center fixed points in the context of classical dynamical systems
...
% FIXME lambda_line and poincare_closed_orbit have been removed from demo scripts. Now use poincare_closed_orbit_range and elliptic_lcs.
\begin{table*}
...
\end{tabular}
\caption{
Syntax for LCS Tool elliptic LCS functions.
Both functions are called by the function \lstinline!poincare_closed_orbit_range!.
}
\label{t:Elliptic LCS functions}
\end{table*}

The first step is to define the position of Poincare sections in regions where closed $\lambda$-lines are expected based on a visual analysis of the orbit structure of the $\eta_\pm^\lambda$ vector field.
The Poincare section is to be oriented such that the first endpoint is close to the centre of the expected Lagrangian vortex, and the second endpoint is outside this vortex.
% FIXME Move citation to conclusions, as a candidate for future work.
There is no automated procedure implemented in LCS Tool for the positioning of Poincare sections (see however \textcite{karrasch14:_autom_lagran} for a recently developed algorithm).
Additionally, the number of lambda-lines launched from the Poincare section, \lstinline!poincareSection.numPoints!, must be defined.
...
\import{graphics/double_gyre/}{poincare_return_map}
\end{center}
...
\hline
bickley\_jet/elliptic\_hyperbolic\_lcs\_details & 25\tabularnewline
\hline
...
\lstinputlisting[
caption={LCS Tool commands for double gyre elliptic LCSs.
Abridged subset of the LCS Tool script \lstinline!demo/double_gyre/elliptic_hyperbolic_lcs.m!},
label=l:double gyre elliptic LCS]
...
\import{graphics/double_gyre/}{elliptic_lcs_500}
\import{graphics/double_gyre/}{elliptic_lcs_750}
\import{graphics/double_gyre/}{elliptic_lcs_1000}
...
\lstinputlisting[
caption={LCS Tool commands for double gyre hyperbolic LCSs.
Abridged subset of the LCS Tool script \lstinline!demo/double_gyre/elliptic_hyperbolic_lcs.m!},
...
\import{graphics/double_gyre/}{elliptic_repelling_lcs}
\import{graphics/double_gyre/}{elliptic_attracting_lcs}
\caption{
...
\lstinputlisting[
caption={LCS Tool commands for Bickley jet elliptic and hyperbolic LCSs.
Abridged version of the LCS Tool script \lstinline!demo/bickley_jet/elliptic_hyperbolic_lcs.m!},
...
\import{graphics/bickley_jet/}{elliptic_repelling_lcs}
\import{graphics/bickley_jet/}{elliptic_attracting_lcs}
\caption{
...
\begin{center}
\setlength\figurewidth{.85\textwidth}
\import{graphics/ocean_dataset/}{elliptic_repelling_lcs}
\import{graphics/ocean_dataset/}{elliptic_attracting_lcs}
\end{center}
\caption{
