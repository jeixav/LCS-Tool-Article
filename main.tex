...
We note that parabolic LCSs (Lagrangian jet cores) are also stationary curves of $Q(\gamma)$, but under variable endpoint perturbations (cf. \citet{farazmand14:_shearless}).
\end{sloppypar}
...
Results obtained with an Intel Core i3-4130 3.4 GHz processor.
}
...
Results obtained with an Intel Core i3-4130 3.4 GHz processor with 8 GB of memory.
}
