...
% FIXME Add FlowTK, https://github.com/FlowPhysics/FlowTK, doi:10.1007%2F978-3-319-04099-8_13
\end{itemize}
...
This section describes stepwise the numerical implementation of geodesic detection of elliptic and hyperbolic LCSs based on \cref{eq:etafields,eq:strainline,eq:stretchline}. \Cref{t:LCS Tool overview} gives an overview of the steps, functions and variable names used in LCS Tool to analyse a flow.
