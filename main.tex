...
\lstinputlisting[caption={LCS Tool commands for strainline and stretchline LCSs},label=l:double_gyre_lambda_strain_stretch_lcs]{listings/double_gyre/lambda_strain_stretch_lcs.m}
...
% $[0,2L_x/U]$.
% Loose closed orbits as increase lambda-line integration accuracy
...
% We analyse lambda-line LCSs in a subdomain of this flow.
% 1. FTLE field
% 2. Poincare sections
% 3. Convergence by varying resolution and other parameters.
