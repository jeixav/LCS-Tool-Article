...
\label{eq:eta}
\end{equation}
We call the curves associated with coherent Lagrangian vortices lambda-lines.
...
% \frac{d}{dt} DF_{t_0}^t &= Dv(x,t) DF_{t_0}^t\label{eq:equation of variation}
% \end{align}
% Equation \eqref{eq:equation of variation} is the equation of variation and an initial value problem ordinary differential equations system. The initial condition, $DF_{t_0}^{t_0}$, is the identity matrix. 
